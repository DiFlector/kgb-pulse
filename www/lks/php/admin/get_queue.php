...
try {
    ...
    // Получаем участников в статусе "В очереди" (администратор работает с ожидающими)
    $query = "
        SELECT 
            lr.oid,
            lr.status,
    ...
    error_log("Ошибка в get_queue.php (admin): " . $e->getMessage());
    echo json_encode([
        'success' => false,
